  ...
  >
    <div
      ...
      <div class="md:md:w-1/2 w-full md:mr-2">
        <Input v-model="company.companyName" placeholder="Sirius" label="Firma Ünvanı" />
      </div>
      <div class="md:w-1/2 w-full md:ml-2">
      <Input v-model="company.companyAdress" placeholder="barbaros hayrettin paşa" label="Firma Adresi" />
    </div>
    </div>
    <div
      class="flex w-full md:flex-row flex-col md:my-0 items-center justify-center"
    ...
    <div class="md:w-1/2 w-full md:mr-2">
      <Input v-model="company.phoneNumber" placeholder="05555555555" label="Telefon No" />
    </div>
    <div class="md:w-1/2 w-full md:ml-2">
      <Input v-model="company.mail" placeholder="siriustedarik6654@gmail.com" label="Mail" />
    </div>
    </div>
    <div
      class="flex w-full md:flex-row flex-col md:my-0 items-center justify-center"
    >
    <div class="md:w-1/2 w-full md:mr-2">
      <Input v-model="company.taxAdress" placeholder="Esenyurt" label="Vergi Adresi" />
    </div>
    <div class="md:w-1/2 w-full md:ml-2">
      <Input v-model="company.taxNo" placeholder="123456" label="Vergi No" />
    </div>
    </div>
    <div
      class="md:flex flex md:flex-row flex-col w-full items-center justify-between md:my-2"
    >
      <div class="md:w-5/12 w-full md:my-0 my-2 px-0">
        <Button
          :img-show="false"
